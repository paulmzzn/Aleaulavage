...
<?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
	...
	<ul class="wc-tabs nav nav-tabs mb-4 flex-grow-1 border-0 d-flex justify-content-center" role="tablist">
		<li class="nav-item nav-item-signinup bg-light border-0 connexion_tab active" id="tab-title-connexion" role="tab" aria-controls="tab-description">
			<a class="nav-link bt rounded m-2 border-0 active tab-connexion" href="#tab-connexion">
				Connexion
			</a>
		</li>
		<li class="nav-item nav-item-signinup bg-light border-0 inscription_tab" id="tab-title-inscription_tab" role="tab" aria-controls="tab-inscription_tab">
			<a class="nav-link bt rounded m-2 border-0 tab-inscription_tab" href="#tab-inscription_tab">
				Inscription
			</a>
		</li>
	</ul>

	<div class="d-flex justify-content-center mb-4 ms-2 me-2" id="customer_login">
			...
			<div >
				...
				<form class="woocommerce-form woocommerce-form-login login" method="post">
					...
					<p class="form-row">
						...
						<button type="submit" class="woocommerce-form-login__submit btn btn-outline-secondary" name="login" value="<?php esc_attr_e('Log in', 'woocommerce'); ?>"><?php esc_html_e('Log in', 'woocommerce'); ?></button>
					</p>
		...
		<div class="col-md-4" style="display: none" id="inscription">
			...
			<div class="mt-3">
				...
				<form method="post" <?php do_action('woocommerce_register_form_tag'); ?>>
					...
					<p class="woocommerce-form-row form-row mb-0">
						...
						<button type="submit" class="btn btn-outline-secondary woocommerce-form-register__submit" name="register" value="<?php esc_attr_e('Register', 'woocommerce'); ?>"><?php esc_html_e('Register', 'woocommerce'); ?></button>
					</p>
